/**
 * Sistemas Operativos
 * Autores: Uriel Cabrera y Carlos Nevarez 
*/
# include <stdio.h>
# include <stdlib.h>
# include <unistd.h>
    ...
    */
    ...
    else 
    {
        if(pid==0) // Hijo
        {
            ...
            execBasico(subcomando0, cuentaToken(subcomando0, strlen(subcomando0)));
        ...
        else // padre
        {
            ...
            close(fd[0]); // Cerramos extremo de lectura
            pidw = wait(NULL);
            execBasico(subcomando1, cuentaToken(subcomando1, strlen(subcomando1)));
